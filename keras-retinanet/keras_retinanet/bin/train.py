...
def parse_args(args):
    ...
    parser.add_argument('--tensorboard-dir',  help='Log directory for Tensorboard output', default='./snapshots')  # default='./logs') => https://github.com/tensorflow/tensorflow/pull/34870
